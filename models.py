...
# return the untrained patch description model (PDN)
def get_pdn(channels: int = 512) -> nn.Sequential:
...
# return the untrained autoencoder
def get_autencoder(channels: int = 256) -> nn.Sequential:
    return nn.Sequential(
